...
-- DropIndex
DROP INDEX `t_estadosxincidencias_cn_cod_estado_fkey` ON `t_estadosxincidencias`;

-- DropIndex
DROP INDEX `t_estadosxincidencias_cn_cod_incidencia_fkey` ON `t_estadosxincidencias`;
...
-- AlterTable
ALTER TABLE `t_diagnosticos` ADD COLUMN `ct_requiereCompra` VARCHAR(191) NULL;
