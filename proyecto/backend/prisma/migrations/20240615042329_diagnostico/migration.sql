/*
  ...
  - You are about to drop the column `ct_requiereCompra` on the `t_diagnosticos` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `t_diagnosticos` DROP COLUMN `ct_requiereCompra`;
