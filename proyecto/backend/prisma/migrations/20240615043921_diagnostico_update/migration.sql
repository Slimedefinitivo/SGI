/*
  ...
  - You are about to drop the column `ct_cod_incidencia` on the `t_diagnosticos` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `t_diagnosticos` DROP COLUMN `ct_cod_incidencia`;
